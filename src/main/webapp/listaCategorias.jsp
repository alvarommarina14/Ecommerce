...
<h5> Estos son las categorias que tiene en su supermercado</h5>
...
<form id="form" action="listaCategorias" method="post">
		<table class="table" style="margin: auto; background-color: white">
			...
			<tbody>
				...
				<tr>
					...
					<td><button type="submit" name="order" value="mod-<%=c.getId()%>" class="end-purchase nomar" >Modificar</button></td>
					<td><button type="submit" name="order" value="del-<%=c.getId()%>" class="end-purchase nomar">Eliminar</button></td>
				</tr>
				<%
				}
				%>
		...
		<table class="table" style="margin: auto; background-color: white">
			<tbody>
				...
				<button type="submit" name="order" value="modify" class="end-purchase nomar" style="display: inline">Modificar</button></td>
				</tr>
			</tbody>
		</table>
